...
function appendMessage(role, innerHtml) {
    ...
    const avatarHtml = role === 'bot'
        ? `<img src="img/Minimal Three-Colour Sparkle Cluster.png" alt="" class="ai-avatar-img">`
        : `<i class="fas fa-user"></i>`;
    row.innerHTML = `<div class="ai-msg-avatar">${avatarHtml}</div><div class="ai-msg-bubble">${innerHtml}</div>`;
    log.appendChild(row);
...
function showTyping() {
    ...
    row.id = 'aiTypingRow';
    row.innerHTML = `<div class="ai-msg-avatar"><img src="img/Minimal Three-Colour Sparkle Cluster.png" alt="" class="ai-avatar-img"></div><div class="ai-msg-bubble ai-typing"><span></span><span></span><span></span></div>`;
    log.appendChild(row);
    row.scrollIntoView({ behavior: 'smooth', block: 'end' });
}
